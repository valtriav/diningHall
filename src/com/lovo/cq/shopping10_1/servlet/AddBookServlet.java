...
public class AddBookServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		//String booknumtemp =new String (request.getParameter("bookName").getBytes("GB18030"),"utf-8");
		//booknumtemp = new String(booknumtemp.getBytes("iso8859-1"),"UTF-8");
		//System.out.println("第一次书名编码:"+booknumtemp);
		...
		if(introduce==null)
			...
			System.out.println("content"+introduce);
		...
		byte[] bookName_buf = bookName.getBytes("GBK");
		byte[] ISBN_buf = ISBN.getBytes("iso8859-1");
		byte[] introduce_buf = introduce.getBytes("GBK");
		byte[] publisher_buf = publisher.getBytes("GBK");
		byte[] author_buf = author.getBytes("GBK");
