  ...
  <head>
	...
	<script type="text/javascript" >
		...
		function checkBookName() {
			...
			var bookNameDiv = document.getElementById("bookNameDiv");
			if(bookName.value == "") {
				bookNameDiv.innerHTML = "菜品名称不能为空";
			} else {
		...
		function add() {
			...
			if(s1.value == "0" || s2.value == "0" || s2.value == "") {
				typeDiv.innerHTML = "请匹配楼层和窗口";
			} else if(!bookName_IsExist && !ISBN_IsExist  && checkPublisher_ && checkAuthor_ && checkPrice_  && checkBooksNum_) {
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  	...
  	<tr><td>
    	...
    	<table>
    		<tr>
				<td>选择位置:</td>
				<td>楼层<select id="superTypeId" name="superTypeId" onchange="getSubType()">
				...
				<td>
				窗口<select id="subTypeId" name="subTypeId">
					<option value="0">--选择窗口--</option>
					</select>
					</td>
			...
			<tr>
    			<!--  <td>书的页数:</td>-->
				<td><input type="text" id="pages" value=123 name="pages" onblur="checkPages()"/></td>
    		...
    		<tr>
				<!--  <td>现价:</td>-->
				<td><input type="text" id="nowPrice" value=1 name="nowPrice" onblur="checkNowPrice()"/></td>
