  ...
  <body>
	...
	<div id="middle">
		<div id="left-column">
			...
			<div class="left-column-box">
				...
				<div id="manageProduct" style="display:none; ">
					<ul>
						<li><a href="Admin/pages/addSuperType.jsp" target="contentIframe" style="text-decoration:none; ">添加楼层</a></li>
						<li><a href="Admin/pages/addSubType.jsp" target="contentIframe" style="text-decoration:none; ">添加窗口</a></li>
						<li><a href="Admin/pages/addBooks.jsp" target="contentIframe" style="text-decoration:none; ">添加菜品</a></li>
						<li><a href="getBookPagerServlet" target="contentIframe" style="text-decoration:none; ">查看菜品</a></li>
					</ul>
				</div>
			</div>
			<div class="left-column-box">
		...
		<div id="content" style="background-image: url(Admin/pages/beijing.jpg)">
			<iframe name="contentIframe" scrolling="auto" frameborder="0" width="100%" height="100%" style="width:652.9px;"></iframe>
		</div>
	</div>
	<div id="footer">
    ...
    <td height="24" background="Admin/images/main_47.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="369"><span class="STYLE1">版本 计算机1607 侯会文组成员 </span></td>
            <td width="814" class="STYLE1">&nbsp;</td>
            <td width="185" nowrap="nowrap" class="STYLE1"><div align="center"><img src="Admin/images/main_51.gif" width="12" height="12" /> 如有疑问请与我们联系</div></td>
          </tr>
        </table></td>
