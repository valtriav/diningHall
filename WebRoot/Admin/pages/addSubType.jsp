	...
	<script type="text/javascript">
		...
		function checkSubTypeName() {
			...
			if(subTypeName.value == "") {
				subTypeNameDiv.innerHTML = "窗口名不能为空";
			} else {
...
<form action="addSubTypeServlet" method="get">
    <table id="t2">
		<tr>
			<td>
				窗口名称:<input type="text" id="subTypeName" name="subTypeName" onblur="checkSubTypeName()"/>
				所属楼层:<select id="superTypeId" name="superTypeId" onchange="getSubType()" style="width:80px;">
