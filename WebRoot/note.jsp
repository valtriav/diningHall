						...
						<div style="text-align: center;color:#a53d17;">
	                     ...
	                     <div style="text-align: center;color:#a53d17;margin-top:10px;">
		                    ...
		                    <textarea rows="5" cols="40" name="ly_content" class="contact_input"></textarea> 
	                   		 ...
	                   		 <div id="face">
	                   		 	<strong>选择留言头像： </strong></br>
	                   		 			
	                   		 				<input type="radio" name="pic" value="images/face/pic1.gif" checked="checked" /><img src="images/face/pic1.gif" /><br />
	                   		 				<input type="radio" name="pic" value="images/face/pic2.gif" /><img src="images/face/pic2.gif" /><br />
	                   		 				<input type="radio" name="pic" value="images/face/pic3.gif" /><img src="images/face/pic3.gif" /><br />
	                   		 				<input type="radio" name="pic" value="images/face/pic4.gif" /><img src="images/face/pic4.gif" /><br />
	                   		 				<input type="radio" name="pic" value="images/face/pic5.gif" /><img src="images/face/pic5.gif" /><br />
	                   		 				<input type="radio" name="pic" value="images/face/pic6.gif" /><img src="images/face/pic6.gif" /><br />
	                   		 				<!--  
	                   		 				<input type="radio" name="pic" value="images/face/pic7.gif" /><img src="images/face/pic7.gif" /><br />
	                   		 				<input type="radio" name="pic" value="images/face/pic8.gif" /><img src="images/face/pic8.gif" /><br />
	                   		 				-->
	                   		 </div>
	                   		 <div class="form_row">
