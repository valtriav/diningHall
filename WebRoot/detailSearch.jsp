								...
								<tr>
									...
									<td>
										<select id="superType" name="superType" onchange="selectedSuper()">
											<option value="noChoice">--请选择楼层--</option>
								...
								<tr>
									...
									<td>
										<select id="subT" name="subT" >
											<option value="noChoice">--请选择窗口--</option>
											<c:forEach var="chuangkouflag" items="${subList}">
						  					<option value="${chuangkouflag.subTypeId}">${chuangkouflag.subTypeName}</option>
						  					</c:forEach>
										</select>
									</td>
								</tr>
								...
								<tr>
									...
									<td style="visibility: hidden;" id="price2">
										<select id="prices" name="prices">
											...
											<option value="0-3">3元以下</option>
											<option value="3-5">3-5元</option>
											<option value="5-8">5-8元</option>
											<option value="大于8">8元以上</option>
										</select>
									</td>
								</tr>
								<tr>
