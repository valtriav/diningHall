...
<%@include file="common.jsp" %>
   	 <div class="right_content">
                 ...
                 <form name="login" action="login" method="post">          
					<fieldset>
						...
						<table>
							...
							<tr >
								<td>&nbsp;</td>
								<td align="right"><input type="checkbox" name="cookie" />记住密码</td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td><input type="submit" class="register" value="登录" /></td>
								<td><a class="register" href="register.jsp" style="color:#FFFFFF;">注册</a></td>
								<td>&nbsp;</td>
							</tr>
							<tr>
								<td>&nbsp;</td>
								<td align="right"><a href="PwdIndex.jsp"><font color="#3333CC">忘记密码?</font></a></td>
								<td>&nbsp;</td>
							</tr>
						</table>
					</fieldset>    
              ...
              <!-- 
             <div class="right_box">
             	<div class="title"><span class="title_icon"><img src="images/bullet4.gif" alt="" title="" /></span>特价菜品&nbsp;&nbsp;<a href="page?type=3" class="more">-更多-</a></div> 
